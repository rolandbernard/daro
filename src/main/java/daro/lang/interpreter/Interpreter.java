 ...
 * implemented using multiple visitors ({@link Executor}, {@link LocationEvaluator},
...
public class Interpreter {
     ...
     * @param globalScope The scope to execute in
     */
     ...
     * execute method will execute. This method will initialize the interpreter with a default
     * gloabl scope.
     */
    public Interpreter() {
    ...
    /**
     * Execute the given {@link AstNode} inside the {@link Interpreter} with the given
