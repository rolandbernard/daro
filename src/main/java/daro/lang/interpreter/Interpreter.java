...
/**
 * This is the main interface into the daro interpreter. This class implements a
 * simple low setup time interpreter for the Daro language. It is implemented
 * using multiple visitors ({@link Executor}, {@link LocationEvaluator},
...
public class Interpreter {
    ...
    /**
     * Create a new {@link Interpreter} using the given {@link PrintStream} as an
     * output for print functions instead of the default System.out.
     * 
     * @param output The output stream for print functions
     */
    ...
    /**
     * Create a new {@link Interpreter}. Each interpreter has it's own context in
     * which every execute method will execute. This method will initialize the
     * interpreter with a default global scope.
     */
    public Interpreter() {
        this(System.out);
    }
    ...
    /**
     * Execute the given {@link AstNode} inside the {@link Interpreter} with the
     * given {@link ExecutionObserver}s.
     * 
    ...
    /**
     * Parses and executes the code inside the given source. All statements in the
     * source will be executed in the global scope of the interpreter and functions,
     * class and variables in the code will be accessible for subsequent execute
     * calls. Also install the given {@link ExecutionObserver}s before execution and
     * uninstall them afterwards.
     * 
    ...
    /**
     * Parses and executes the code inside the given file. All statements in the
     * source will be executed in the global scope of the interpreter and functions,
     * class and variables in the code will be accessible for subsequent execute
     * calls. Also install the given {@link ExecutionObserver}s before execution and
     * uninstall them afterwards.
     * 
     * @param file      The code that should be executed
     * @param observers The observers to execute with
     * @return The result of the execution
     * @throws InterpreterException It the code causes an exception during execution
     * @throws ParsingException     It the source cannot be parsed
