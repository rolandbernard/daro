...
/**
 * This class represents the type for a function object ({@link DaroFunction}).
 * All functions have the same type for now. Functions can not be initialized
 * using new but have to be created using the fn syntax.
 * 
