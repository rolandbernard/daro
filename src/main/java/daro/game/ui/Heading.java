...
public class Heading extends VBox {
     ...
     * @param heading a string containing main heading (e.g. Course, Playground...)
     * @param description a string containing a description, showing information about the page
     */
